...
export const metadata = {
  title: "Sport · Serwis Informacyjny Konopiska",
  description: "Wydarzenia sportowe, sukcesy lokalnych drużyn oraz jubileusze klubów sportowych w Gminy Konopiska.",
}
...
export default function SportPage() {
  ...
  // Filter items matching Sport
  const filteredItems = newsItems.filter((item) => item.category === "Sport")
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <PageHero
        eyebrow="Gminna arena"
        title="Sport i Rekreacja"
        description="Wiadomości o lokalnych klubach sportowych, meczach GLKS LOT Konopiska, turniejach dziecięcych, lekkoatletyce oraz infrastrukturze sportowej."
        breadcrumb={[
          { label: "Serwis", href: "/" },
          { label: "Sport" },
        ]}
      ...
      <section className="mx-auto max-w-[90rem] px-4 py-16 sm:px-6">
        ...
        {lead ? (
          ...
          <div className="rounded-3xl border border-border bg-card p-12 text-center">
            <p className="text-muted-foreground">Brak artykułów sportowych w tym momencie.</p>
          </div>
        )}
            ...
            <div className="mb-8 flex items-end justify-between gap-6 border-b border-border pb-4">
              <div>
                ...
                <h3 className="mt-2 font-serif text-2xl font-semibold tracking-tight text-foreground">
                  Inne doniesienia ze świata sportu
                </h3>
              </div>
            </div>
